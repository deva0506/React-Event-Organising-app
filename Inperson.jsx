  ...
  return (
    ...
    <ThemeProvider theme={defaultTheme}>
      ...
      <Container component="main" maxWidth="md" style={{ 
        ...
        >
          <h1>Spark engagement with a virtual event platform</h1>
          <p>With our virtual event platform, you can boost your attendees' interaction with you, sponsors, exhibitors, and each other.</p>
<p>Delight and engage your audience with an end-to-end virtual event solution: Casino Attendee Hub®.</p>
        </div>
